...
| | |
| --- | --- |
| **Last green gate** | G21 — no test makes a live network call |
| **Now working on** | G21 — the suite is held off the network by something other than everyone's good intentions |
