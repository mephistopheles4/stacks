...
| **Queued** | [#25](https://github.com/mephistopheles4/stacks/issues/25) shelf placement · [#27](https://github.com/mephistopheles4/stacks/issues/27) a `scripts/` harness — from the same architecture review as G20 |
...
of the ~27 inline conditional spreads is anywhere near one. `enrich.ts` cannot
...
The ~27 inline spreads were left alone, as filed. They share the same text and
