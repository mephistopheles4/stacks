...
| [0041](./0041-a-gate-has-a-number-and-a-name.md)                           | A gate has a number _and_ a name, and the name is anchored to its spec                          |
...
| [0047](./0047-the-contributor-set-is-the-id-keys.md)                       | The contributor set _is_ the set of id keys, and they are ids rather than URLs                  |
...
| [0062](./0062-the-dashboard-is-provisioned-from-the-repo.md)               | The dashboard is provisioned from the repo, and the panel order is the artifact                 |
