...
Open Library first, Google Books as the fallback, and Apple Books consulted _only_ for cover art because its artwork is ~800x1200 against Google's ~128px. Every response is cached under `.cache/`.
