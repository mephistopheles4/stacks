...
## These labels do not exist on the repo yet

The mapping is recorded; the labels themselves have not been created. `/triage`
creates or applies them on first use. Creating them ahead of time is one command
each:
