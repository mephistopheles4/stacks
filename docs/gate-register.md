...
**Triage for 18 rows; the deep pass has run on the other 17.** The population was
...
The **Deep pass** block, present on the eight rank-1 rows, the four rank-3 rows
and the five unranked ones, is band one
([#128](https://github.com/mephistopheles4/stacks/issues/128)), band three
([#133](https://github.com/mephistopheles4/stacks/issues/133)) and band four
([#134](https://github.com/mephistopheles4/stacks/issues/134)): defects actually
planted, gates actually run, dispositions filled in. Where the two disagree, the
Deep pass block is the evidence and the triage line is the guess it replaced —
and in **every** band so far they do disagree, in both directions. See **Band
one**, **Band three** and **Band four**, below.
...
**eight** rank-2 rows are the only flagged ones still awaiting a band.
