...
Title: `<type>(<scope>): <subject>` — type from build, chore, ci, docs, feat,
fix, perf, refactor, revert, style, test; scope optional, from core, cli, site,
gates, docs, ci. This repo squash-merges, so the title you write here becomes
the commit subject on main and this body becomes its message.
