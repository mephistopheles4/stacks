...
const COVERS: readonly CoverSpec[] = [
  {
    file: "the-tidal-engine.png",
    base: "#2f6d7a",
    accent: "#e0c8a0",
    fullSize: true,
  },
  {
    file: "compilers-for-the-impatient.png",
    base: "#8a3b2e",
    accent: "#f0d8b8",
  },
  { file: "signal-and-sediment.png", base: "#4a6b5a", accent: "#d8e0c8" },
  {
    file: "nine-ways-of-seeing-a-warehouse.png",
    base: "#6a5a8c",
    accent: "#e8dcf0",
  },
  { file: "the-salt-road-ledger.png", base: "#b08442", accent: "#2a2018" },
  {
    file: "the-salt-road-ledger-audio.png",
    base: "#3a4a6b",
    accent: "#c8d4e8",
  },
  {
    file: "white-bordered.png",
    base: "#7a3f5d",
    accent: "#f4e4d0",
    whiteBorder: true,
  },
