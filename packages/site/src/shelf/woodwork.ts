 ...
 * which is why [#285](https://github.com/mephistopheles4/stacks/issues/285)
 * *states* each member's direction.
 *
 ...
 * `rowsForBookcase` keeps one empty row ahead; and an empty vault gives three
